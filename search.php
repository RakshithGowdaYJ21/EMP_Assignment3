...
<form class="py-3 mt-5" name="form1" method="post" action="search_emp.php">
		<div class="container">
			<div class="row">
				<div class="col-md-2">
				...
				<div class="col-md-8">
					<div class="card p-4">
						<div class="card-body">
							<h3 class="text-center">Search Employee Details</h3>
							<hr>
							<div class="row">
								<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-12">
									<input type="submit" name="submit" value="Search" class="btn btn-outline-info btn-lg pl-3 ml-4">
								</div>
							</div>
						</div>
					</div>
